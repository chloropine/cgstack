...
- Save the report to .cgstack/security-reports/.`,
    ...
    const reportDir = path.join(csoDir, '.cgstack', 'security-reports');
...
- Skip the preamble (cgstack-update-check, telemetry, etc.) — go straight to the audit.
