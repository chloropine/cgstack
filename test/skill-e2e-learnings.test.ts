...
describeIfSelected('Learnings E2E', ['learnings-show'], () => {
  ...
  beforeAll(() => {
    ...
    // Seed learnings JSONL — slug must match what cgstack-slug computes.
    // With no git remote, cgstack-slug falls back to basename(workDir).
...
- Replace any references to ~/.codex/skills/cgstack/bin/cgstack-slug with ./bin/cgstack-slug.
