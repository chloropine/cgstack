/**
 * cgstack-gbrain-mcp-verify — error-classification tests with a mocked curl.
 *
...
const VERIFY_BIN = path.join(ROOT, 'bin', 'cgstack-gbrain-mcp-verify');
...
beforeEach(() => {
  tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), 'cgstack-mcp-verify-test-'));
...
describe('cgstack-gbrain-mcp-verify', () => {
