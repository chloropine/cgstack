/**
 * bin/cgstack-question-log — schema validation + injection defense tests.
 */
...
const BIN = path.join(ROOT, 'bin', 'cgstack-question-log');
...
describe('cgstack-question-log — valid payloads', () => {
...
describe('cgstack-question-log — rejected payloads', () => {
...
describe('cgstack-question-log — injection defense', () => {
  const attacks = [
