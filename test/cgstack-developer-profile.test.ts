...
const BIN_DEV = path.join(ROOT, 'bin', 'cgstack-developer-profile');
const BIN_LOG = path.join(ROOT, 'bin', 'cgstack-question-log');

let tmpHome: string;

beforeEach(() => {
  tmpHome = fs.mkdtempSync(path.join(os.tmpdir(), 'cgstack-test-'));
});
...
describe('cgstack-developer-profile --read', () => {
...
describe('cgstack-developer-profile --migrate', () => {
...
describe('cgstack-developer-profile tier calculation', () => {
...
describe('cgstack-developer-profile --derive', () => {
...
describe('cgstack-developer-profile --trace <dim>', () => {
...
describe('cgstack-developer-profile --gap', () => {
...
describe('cgstack-developer-profile --vibe', () => {
...
describe('cgstack-developer-profile --check-mismatch', () => {
...
describe('cgstack-developer-profile errors', () => {
