 ...
 * not spawn `codex` or pay any API cost. Reads the project eval dir
 * (~/.cgstack/projects/<slug>/evals/) and compares the latest run against
 * its predecessor.
 *
 ...
 *
 * Override: CGSTACK_BUDGET_RATIO=<n> (default 2.0).
 *
