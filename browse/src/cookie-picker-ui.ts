...
<title>Cookie Import — cgstack browse</title>
<style>
...
<p class="subtitle">Select the domains of cookies you want to import to CGStack Browser. You'll be able to browse those sites with the same login as your other browser.</p>
