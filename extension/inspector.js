/**
 * cgstack browse — CSS Inspector content script
 *
...
(() => {
  ...
  if (window.__cgstackInspectorActive) return;
  window.__cgstackInspectorActive = true;
  ...
  function createHighlight() {
    ...
    highlightEl.id = 'cgstack-inspector-highlight';
    ...
    tooltipEl.id = 'cgstack-inspector-tooltip';
  ...
  function onMouseMove(e) {
    ...
    if (target.id === 'cgstack-inspector-highlight' || target.id === 'cgstack-inspector-tooltip') return;
  ...
  function injectCSS(id, css) {
    ...
    const styleId = `cgstack-inject-${id}`;
